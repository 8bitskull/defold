...
(defn- render-mesh-opaque-impl [^GL2 gl render-args renderable request-prefix override-shader override-vertex-description extra-render-args]
  (let [{:keys [node-id user-data ^Matrix4d world-transform]} renderable
        ...
        ;; TODO(instancing): Something like this?
        #_#_
        instance-buffer (scene-cache/request-object!
                          ::instance-buffer request-id gl
                          {:vertex-description instance-description
                           :instance-attribute-bytes instance-attribute-bytes})
        #_#_
        instance-buffer-binding (vtx/use-with request-id instance-buffer shader)]
    (gl/with-gl-bindings gl render-args [shader vertex-buffer-binding #_ instance-buffer-binding]
